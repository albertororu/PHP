...
<body>
	...
	<div id="encabezado">
		...
		<form id="form_seleccion" action="plantilla.php" method="post">
			<span>Producto: </span>
				...
				if ($error == null) {
					...
					if ($resultado) {
						...
						while ($row != null) {
							...
							// Si se recibió un código de producto lo seleccionamos en el desplegable usando selected='true'
	...
	<div id="contenido">
		...
		<?php
		// Si se recibió un código de producto y no se produjo ningún error mostramos el stock de ese producto en las distintas tiendas
